...
const PetPlate = (props) => {
    ...
    return (
        <div>
            <div className='profile-pic-container'><Link>
                <p><img src={default_pet_profile_pic}/></p>
                <p>upload photo</p>
                </Link>
            </div>
                    ...
                    >
                    {
                        Object.keys(Constants.availability_options).map(key =>
                            <option
                                ...
                                value={key}
                                onChange={(e) => setAvailability(e.target.value)}
                            > {Constants.availability_options[key]} </option>
                        )
                    }
                    </select>
                </div>
